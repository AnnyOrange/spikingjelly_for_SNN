...
class T(nn.Module):
    def __init__(self, img_size=64, patch_size=1, in_chans=31,
                 embed_dim=96, depths=[2, 4, 4], num_heads=[3, 3, 3],
...
if __name__ == '__main__':
    ...
    input = torch.randn(32, 32, 64, 64).cuda()  # BxCxHxW
    t = T(img_size=64, patch_size=1, in_chans=32, embed_dim=32, depths=[2, 4, 4], num_heads=[8, 8, 8], window_size=4).cuda()
    output = t(input)
    print(output.shape)
