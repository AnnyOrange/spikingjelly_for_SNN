...
class Swinnet(PatchMergeModule):
    def __init__(self, args):
        ...
        self.t = T(img_size=self.img_size, patch_size=1, in_chans=34, embed_dim=32, depths=[1, 3], num_heads=[8, 8], window_size=4)
...
def build(args):
    ...
    print('[Network %s] Total number of parameters : %.3f M' % ('Swin_m', num_params / 1e6))
